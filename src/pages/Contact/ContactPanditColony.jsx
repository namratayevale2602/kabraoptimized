...
const ContactPanditColony = () => {
   useSEO("contactPanditColony");

    // Add LocalBusiness schema data
  const localBusinessSchema = {
    "name": "Kabra Emporium - Wholesale Branch",
    "description": "Flagship store of Kabra Emporium in Wholesale Branch, Nashik. A 3‑generation heritage saree store offering traditional Indian weaves.",
    "image": "https://kabraemporium.com/assets/location/panditcolony.webp",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Padma-vishwa Centre Old Wholesale Branch Sharanpur Road, opp. Rajiv Gandhi Bhavan",
    ...
    "url": "https://kabraemporium.com/contact/wholesale-branch",
  ...
  const { branchKey = "wholesale-branch" } = useParams();
  ...
  useEffect(() => {
    const fetchBranchData = async () => {
      ...
      setError(null);
      try {
        const response = await axiosInstance.get(`/contact-details/wholesale-branch`);
...
export default ContactPanditColony;