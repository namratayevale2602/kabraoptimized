...
const ContactMainBranch = () => {
   useSEO("contactMainBranch");

    // Add LocalBusiness schema data
  const localBusinessSchema = {
    "name": "Kabra Emporium - Pandit Colony",
    "description": "3‑generation-old heritage saree store in Pandit Colony, Nashik. Specializing in traditional Indian weaves with authenticity and warmth.",
    "image": "https://kabraemporium.com/assets/location/panditcolony.webp",
    "address": {
      "@type": "PostalAddress",
      "streetAddress": "Padma-vishwa Centre Old Pandit Colony Sharanpur Road, opp. Rajiv Gandhi Bhavan",
    ...
    "geo": {
      "@type": "GeoCoordinates",
      "latitude": "20.0017667",
      "longitude": "73.7742143"
    },
    "url": "https://kabraemporium.com/contact/main-branch",
    ...
    "priceRange": "₹₹",
    "areaServed": "Nashik",
    "hasMap": "https://maps.google.com/?q=Kabra+Emporium+Pandit+Colony+Nashik"
  };

  const { branchKey = "main-branch" } = useParams();
  ...
  useEffect(() => {
    const fetchBranchData = async () => {
      ...
      setError(null);
      try {
        const response = await axiosInstance.get(`/contact-details/main-branch`);
...
export default ContactMainBranch;